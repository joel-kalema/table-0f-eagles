...
const Timer = () => {
  ...
  return (
    <div style={{ textAlign: "center", margin: "auto" }}>
      ...
      <h2 data-scroll data-scroll-speed='0.3' className={`${time.className} text-3xl overflow-hidden`}><span>{timer[0]}</span><span>{timer[1]}</span><span>{timer[2]}</span> <span className="text-sm">days</span>, 
