...
export default function Location() {
    ...
    return (
        <div className="pb-[10rem] lg:mt-[20rem] px-6 md:px-10">
            <div className="flex flex-col lg:flex-row lg:items-center">
                ...
                <div data-scroll data-scroll-speed='0.6' className="text-center lg:text-start lg:w-1/2 mt-[-10rem] lg:ml-[-14rem] lg:pr-20 text-[1.1rem]">
                    <h1 className={`${prompt.className} text-6xl mb-10 justify-center lg:justify-start flex items-center`}>Location <CiLocationOn /></h1>
