...
export default function People() {
    ...
    return (
        <div className="logo flex justify-center items-center flex-col">
            <div className="md:w-1/43 lg:w-1/4 overflow-hidden mb-10">
